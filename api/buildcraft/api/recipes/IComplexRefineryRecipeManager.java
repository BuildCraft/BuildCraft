...
public interface IComplexRefineryRecipeManager {
    IHeatableRecipe createHeatingRecipe(FluidStack in, FluidStack out, int heatDifferenceRequired, int ticks);
    
    default IHeatableRecipe addHeatableRecipe(FluidStack in, FluidStack out, int heatDifferenceRequired, int ticks, boolean replaceExisting) {
        return getHeatableRegistry().addRecipe(createHeatingRecipe(in, out, heatDifferenceRequired, ticks), replaceExisting);
    }

    ICoolantRecipe createCoolantRecipe(FluidStack in, FluidStack out, int heatDifferenceProvided, int ticks);
    
    default ICoolantRecipe addCoolantRecipe(FluidStack in, FluidStack out, int heatDifferenceProvided, int ticks, boolean replaceExisting) {
        return getCoolantRegistry().addRecipe(createCoolantRecipe(in, out, heatDifferenceProvided, ticks), replaceExisting);
    }
    ...
    IComplexRefineryRegistry<ICoolantRecipe> getCoolantRegistry();
    ...
    public interface ICoolantRecipe extends IHeatExchangerRecipe {}
