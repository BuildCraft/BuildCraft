...
public abstract class FillerPattern implements IFillerPattern {
	 ...
	 */
	@Override public abstract boolean iteratePattern(TileEntity tile, IBox box, ItemStack stackToPlace);
	
	@Override public abstract String getTextureFile();	
	@Override public abstract int getTextureIndex ();
