...
import buildcraft.core.utils.world.DebugWorldAccessor;
...
//		GlStateManager.scale(info.maxX - info.minX, info.maxY - info.minY, info.maxZ - info.minZ);
		...
		renderBlocks.renderBlock(state, DebugWorldAccessor.getPositionForBlockState(state), DebugWorldAccessor.getDebugWorld(), renderer);
		tessellator.draw();
