...
public class TileProgrammingTable_Neptune extends TileLaserTableBase implements IHasWork {
    ...
    public List<IProgrammingRecipe> optionRecipes = Lists.newArrayList();
    public int optionId;
    ...
    public void update() {
        ...
        if (this.input.getStackInSlot(0).isEmpty()) {
            // currentRecipe = null;
            optionRecipes = Lists.newArrayList();
            return;
        }
...
//    }
    ...
    public void load(BlockState state, CompoundNBT nbt) {
        ...
        if (nbt.contains("recipeId") && nbt.contains("optionId")) {
            ...
            ListNBT recipeIdTag = nbt.getList("recipeId", Constants.NBT.TAG_STRING);
    ...
    public CompoundNBT save(CompoundNBT nbt) {
        ...
        if (!availableRecipeIds.isEmpty()) {
            ...
            ListNBT recipeIdTag = NBTUtilBC.writeStringList(availableRecipeIds.stream().map(ResourceLocation::toString));
    ...
    public void findRecipe() {
        ...
        List<ResourceLocation> oldIds = Lists.newArrayList(availableRecipeIds);
        // currentRecipeId = null;
        availableRecipeIds.clear();
