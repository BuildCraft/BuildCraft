...
public class BCSiliconConfig {
    ...
    private static List<String> facadeBlockNamespaceFilter = Lists.newArrayList();
    private static List<ResourceLocation> facadeBlockIdFilter = Lists.newArrayList();
    ...
    public static void createProps() {
        ...
        propFacadeBlockNamespaceFilter = config
                .defineList(display,
                        ...
                        EnumRestartRequirement.WORLD,
                        "facadeBlockNamespaceFilter", Lists.newArrayList());
        propFacadeBlockIdFilter = config
                .defineList(display,
                        ...
                        EnumRestartRequirement.WORLD,
                        "facadeBlockIdFilter", Lists.newArrayList());
...
//    }
    ...
    /** Forced in {@link ItemPluggableFacade#addSubItems(ItemGroup, NonNullList)} */
