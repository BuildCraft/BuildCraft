...
public class PluggableLens extends PipePluggable {
    ...
    public PluggableLens(PluggableDefinition def, IPipeHolder holder, Direction side, CompoundNBT nbt) {
        super(def, holder, side);
    ...
    public PluggableLens(PluggableDefinition def, IPipeHolder holder, Direction side, PacketBuffer buffer) {
        super(def, holder, side);
