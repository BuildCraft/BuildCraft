...
public class SchematicBlockManager {
    ...
    @Nonnull
    public static <S extends ISchematicBlock> CompoundNBT writeToNBT(S schematicBlock) {
        CompoundNBT schematicBlockTag = new CompoundNBT();
    ...
    @Nonnull
    public static ISchematicBlock readFromNBT(CompoundNBT schematicBlockTag) throws InvalidInputDataException {
        ...
        CompoundNBT data = schematicBlockTag.getCompound("data");
        try {
