...
public class RenderMarkerConstruction extends TileEntityRenderer<TileMarkerConstruction> {
    // private final RenderBuildingItems renderItems = new RenderBuildingItems();

    public RenderMarkerConstruction(TileEntityRendererDispatcher context) {
        super(context);
    }

    @Override
    // public void renderTileEntityAt(TileConstructionMarker marker, double x, double y, double z, float f, int aThing)
    public void render(TileMarkerConstruction marker, float partialTicks, MatrixStack poseStack, IRenderTypeBuffer bufferSource, int combinedLight, int combinedOverlay) {
    ...
    public void doRenderItem(MatrixStack poseStack, IVertexBuilder buffer, ItemStack stack, double x, double y, double z, int combinedLight, Direction facing) {
        if (stack == null) {
            return;
        }
...
//        GL11.glPopMatrix();
    ...
    // @Override
    // public void renderTileEntityAt(TileConstructionMarker marker, double x, double y, double z, float f, int aThing)
    public void renderBox(TileMarkerConstruction tileentity, MatrixStack poseStack, IRenderTypeBuffer bufferSource) {
        // GL11.glPushMatrix();
        // GL11.glPushAttrib(GL11.GL_ENABLE_BIT);
        // GlStateManager.enableCull();
