...
public class BCItemTagsGenerator extends ItemTagsProvider {
    ...
    protected void addTags() {
        ...
        tag(OreDictionaryTags.GEARS)
                .addOptionalTag(OreDictionaryTags.GEAR_WOOD.getName())
                .addOptionalTag(OreDictionaryTags.GEAR_STONE.getName())
                .addOptionalTag(OreDictionaryTags.GEAR_IRON.getName())
                .addOptionalTag(OreDictionaryTags.GEAR_GOLD.getName())
                .addOptionalTag(OreDictionaryTags.GEAR_DIAMOND.getName())
        ;
        ...
        tag(OreDictionaryTags.SEALANT)
                .addOptionalTag(Tags.Items.DYES_GREEN.getName())
                .addOptionalTag(Tags.Items.SLIMEBALLS.getName())
        ;
...
//        addAllOptional(tag(OreDictionaryTags.pipeFluidObsidian), BCTransportItems.pipeFluidObsidian.values().stream().map(reg -> reg));
    ...
    private static void addAllOptional(Builder<Item> tag, Stream<RegistryObject<?>> allToAdd) {
