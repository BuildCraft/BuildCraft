...
public class LibFrozenFluidTextureProvider extends BCBaseTextureGenerator {
    ...
    private void genFrozen(Path mainOutput, ResourceLocation still, ResourceLocation frozen, DirectoryCache cache) throws IOException {
        IResource stillMcmetaResource = exFileHelper.getResource(still, ResourcePackType.CLIENT_RESOURCES, ".png.mcmeta", "textures");
        IResource stillResource = exFileHelper.getResource(still, ResourcePackType.CLIENT_RESOURCES, ".png", "textures");
