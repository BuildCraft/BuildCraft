...
public class RenderLiquidHopper extends TileEntitySpecialRenderer implements IInventoryRenderer {

	private static final ResourceLocation HOPPER_TEXTURE = new ResourceLocation(DefaultProps.TEXTURE_PATH_BLOCKS + "/liquid_hopper.png");
	private static final ResourceLocation HOPPER_MIDDLE_TEXTURE = new ResourceLocation(DefaultProps.TEXTURE_PATH_BLOCKS + "/liquid_hopper_middle.png");
