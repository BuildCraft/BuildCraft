...
@OnlyIn(Dist.CLIENT)
public class RenderPump extends TileEntityRenderer<TilePump> {
...
//                dX = -facing.getAxisDirection().getOffset();
    ...
    public RenderPump(TileEntityRendererDispatcher context) {
        super(context);
    }
...
//    public void renderTileEntityFast(@Nonnull TilePump tile, double x, double y, double z, float partialTicks, int destroyStage, float partial, @Nonnull BufferBuilder buffer)
    public void render(TilePump tile, float partialTicks, MatrixStack poseStack, IRenderTypeBuffer bufferSource, int combinedLight, int combinedOverlay) {
