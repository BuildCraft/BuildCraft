...
public class ContainerRefineryControl extends BuildCraftContainer{
	...
	TileHopper refineryControl;

	public ContainerRefineryControl(InventoryPlayer inventory, TileHopper tile) {
		super(tile.getSizeInventory());
		playerIInventory = inventory;
		refineryControl = tile;
	...
	public boolean canInteractWith(EntityPlayer entityPlayer) {
		return refineryControl.isUseableByPlayer(entityPlayer);
	}
