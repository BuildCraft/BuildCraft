...
public abstract class StatementType<S extends IGuiSlot> {
    ...
    /** Reads a {@link StatementWrapper} from the given {@link CompoundNBT}. The tag compound will be equal to the
     * one returned by {@link #writeToNbt(IGuiSlot)} */
    public abstract S readFromNbt(CompoundNBT nbt);

    public abstract CompoundNBT writeToNbt(S slot);
