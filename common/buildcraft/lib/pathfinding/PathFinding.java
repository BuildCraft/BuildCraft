...
public class PathFinding implements IIterableAlgorithm {
    ...
    private HashMap<BlockPos, Node> openList = new HashMap<BlockPos, Node>();
    private HashMap<BlockPos, Node> closedList = new HashMap<BlockPos, Node>();
    ...
    public PathFinding(Level iWorld, BlockPos iStart, BlockPos iEnd, double iMaxDistanceToEnd, float iMaxTotalDistance) {
