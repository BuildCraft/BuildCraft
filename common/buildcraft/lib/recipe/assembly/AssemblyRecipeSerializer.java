...
public class AssemblyRecipeSerializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<IAssemblyRecipe> {
    ...
    public IAssemblyRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
        ...
        EnumAssemblyRecipeType subType = EnumAssemblyRecipeType.valueOf(JSONUtils.getAsString(json, "subType"));
    ...
    @Nullable
    @Override
    public IAssemblyRecipe fromNetwork(ResourceLocation recipeId, PacketBuffer buffer) {
        IAssemblyRecipe recipe = null;
    ...
    @Override
    public void toNetwork(PacketBuffer buffer, IAssemblyRecipe recipe) {
