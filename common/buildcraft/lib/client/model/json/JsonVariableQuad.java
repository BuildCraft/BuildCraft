...
public class JsonVariableQuad {
    public boolean shade = false;
    public IExpressionLong tint;
    public IExpressionString texture;
    public final JsonVertex[] vertices = new JsonVertex[4];
    public EnumFacing face;

    public JsonVariableQuad(JsonObject obj, float[] from, float[] to, EnumFacing face, FunctionContext fnCtx) {
        this.face = face;
