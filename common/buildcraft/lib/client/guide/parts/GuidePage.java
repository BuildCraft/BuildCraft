...
//         this.title = StringUtilBC.formatStringForWhite(entry.title);
         this.title = new StringTextComponent(StringUtilBC.formatStringForWhite(entry.title.getString()));
...
//             parts.add(new GuideChapterWithin(gui, LocaleUtil.localize("buildcraft.guide.meta.group.linking_to")));
             parts.add(new GuideChapterWithin(gui, "buildcraft.guide.meta.group.linking_to", new TranslationTextComponent("buildcraft.guide.meta.group.linking_to")));
...
//             parts.add(new GuideChapterWithin(gui, LocaleUtil.localize("buildcraft.guide.meta.group.linked_from")));
             parts.add(new GuideChapterWithin(gui, "buildcraft.guide.meta.group.linked_from", new TranslationTextComponent("buildcraft.guide.meta.group.linked_from")));
