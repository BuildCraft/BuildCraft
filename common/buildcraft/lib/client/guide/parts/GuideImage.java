...
*/
    ...
    public PagePosition renderIntoArea(GuiGraphics guiGraphics, int x, int y, int width, int height, PagePosition current, int index) {
        ...
        if (index == current.page) {
            ...
            int w = this.width;
            int h = this.height;
            icon.drawAt(guiGraphics, x, y);

            GuiGuide.BORDER_TOP_LEFT.drawAt(guiGraphics, x, y);
            GuiGuide.BORDER_TOP_RIGHT.drawAt(guiGraphics, x + w - GuiGuide.BORDER_TOP_RIGHT.width, y);
            GuiGuide.BORDER_BOTTOM_LEFT.drawAt(guiGraphics, x, y + h - GuiGuide.BORDER_BOTTOM_LEFT.height);
            GuiGuide.BORDER_BOTTOM_RIGHT.drawAt(guiGraphics, x + w - GuiGuide.BORDER_BOTTOM_RIGHT.width, y + h - GuiGuide.BORDER_BOTTOM_RIGHT.height);
        }
