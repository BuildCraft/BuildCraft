...
public abstract class PageValueType<T> {
    ...
    public abstract ITextComponent getTitle(T value);

    public abstract String getTitleKey(T value);

    public abstract List<ITextComponent> getTooltip(T value);

    public abstract void iterateAllDefault(IEntryLinkConsumer consumer, IProfiler prof);
    ...
    public OptionallyDisabled<PageLink> createLink(String to, IProfiler prof) {
