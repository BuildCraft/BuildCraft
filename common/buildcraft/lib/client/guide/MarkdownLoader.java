                ...
                if (line.startsWith("(") && line.endsWith(")")) {
                    ...
                    if (item != null) {
                        ...
                        if (craftingFactory != null) {
                            ...
                            BCLog.logger.warn("[guide-markdown] Didn't find a recipe for " + item);
                            // Unwrap it to what it was before
                            line = "$[special.crafting]" + line;
                        }
                    } else {
                        BCLog.logger.warn("[guide-markdown] Didn't find an item for " + itemText);
                        // Unwrap it to what it was before
                        line = "$[special.crafting]" + line;
                    }
                }
                // Recipe for a complex item
                    ...
                    if (stack != null) {
                        ...
                        if (craftingFactory != null) {
                            ...
                            BCLog.logger.warn("[guide-markdown] Didn't find a recipe for " + stack);
                            // Unwrap it to what it was before
                            line = "$[special.crafting]" + line;
                        }
                    } else {
                        BCLog.logger.warn("[guide-markdown] Didn't find an item for " + line);
                        // Unwrap it to what it was before
                        line = "$[special.crafting]{" + line + "}";
                    }
                } else {
