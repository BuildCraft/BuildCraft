...
public class ItemHandlerManager implements ICapabilityProvider, INBTSerializable<CompoundNBT> {
    ...
    private final Map<String, INBTSerializable<CompoundNBT>> handlers = new HashMap<>();
    ...
    public <T extends INBTSerializable<CompoundNBT> & IItemHandlerModifiable> T addInvHandler(String key, T handler, EnumAccess access, EnumPipePart... parts) {
        if (parts == null) {
...
//    }
    ...
    public CompoundNBT serializeNBT() {
        ...
        for (Entry<String, INBTSerializable<CompoundNBT>> entry : handlers.entrySet()) {
