...
public class BCFluidAttributes extends FluidAttributes {
    ...
    public ITextComponent getDisplayName() {
        ...
        ITextComponent name = getBareLocalizedName();
//        return new StringTextComponent(LocaleUtil.localize("buildcraft.fluid.heat_" + heat, name));
        return new TranslationTextComponent(BCEnergyFluids.FLUID_TRANSLATION_PREFIX + heat, name);
    }

    public ITextComponent getBareLocalizedName() {
