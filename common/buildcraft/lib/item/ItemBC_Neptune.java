...
//    public final void getSubItems(CreativeTabs tab, NonNullList<ItemStack> items)
    public final void fillItemCategory(ItemGroup tab, NonNullList<ItemStack> items) {
//        if (isInCreativeTab(tab))
    ...
    /** Identical to {@link #fillItemCategory(ItemGroup, NonNullList)} in every way, EXCEPT that this is only called if
     * this is actually in the given creative tab.
     *
     * @param tab The {@link ItemGroup} to display the items in. This is provided just in case an item has multiple
