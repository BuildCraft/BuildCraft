...
public class TransactorEntityArrow implements IItemExtractable {
    ...
    private final ArrowEntity entity;

    public TransactorEntityArrow(ArrowEntity entity) {
        this.entity = entity;
    }
    ...
    public ItemStack extract(IStackFilter filter, int min, int max, boolean simulate) {
        if (!entity.isAlive() || entity.pickup != AbstractArrowEntity.PickupStatus.ALLOWED || min > 1 || max < 1 || max < min) {
