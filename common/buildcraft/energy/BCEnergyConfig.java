...
//        EnumRestartRequirement game = EnumRestartRequirement.GAME;
        ...
        propExcessiveBiomes = config
                .defineList("worldgen.oil",
                        ...
                        world,
                        "excessiveBiomes", Arrays.stream(_excessive).collect(Collectors.toList()));
        ...
        propSurfaceDepositBiomes = config
                .defineList("worldgen.oil",
                        ...
                        world,
                        "surfaceDepositBiomes", Arrays.stream(_surface).collect(Collectors.toList()));
        ...
        propExcludedBiomes = config
                .defineList("worldgen.oil",
                        ...
                        world,
                        "excludedBiomes", Arrays.stream(_excluded).collect(Collectors.toList()));
        ...
        propExcludedDimensions = config
                .defineList("worldgen.oil",
                        ...
                        world,
                        "excludedDimensions", Arrays.stream(_dims).collect(Collectors.toList()));
