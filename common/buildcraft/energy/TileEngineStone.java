...
public class TileEngineStone extends TileEngineWithInventory {
	...
	@MjBattery(mode = IOMode.Send, maxCapacity = 1000, maxReceivedPerCycle = 1)
	...
	public void burn() {
		if (burnTime > 0) {
			...
			double e = TARGET_OUTPUT * getMaxEnergy() - mjStored;
			esum = MathUtils.clamp(esum + e, -eLimit, eLimit);
			currentOutput = MathUtils.clamp(e * kp + esum * ki, MIN_OUTPUT, MAX_OUTPUT);
