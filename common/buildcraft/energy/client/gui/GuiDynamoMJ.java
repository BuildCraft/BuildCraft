...
public class GuiDynamoMJ extends GuiBC8<ContainerDynamoMJ> {
    ...
    public GuiDynamoMJ(ContainerDynamoMJ container, PlayerInventory inventory, ITextComponent component) {
            ...
            public void addToolTips(List<ToolTip> tooltips) {
                if (contains(mainGui.mouse)) {
                    ...
                    for (Map.Entry<RegistryObject<ItemBC_Neptune>, Long> entry : TileEngineRF.RF_UPGRADE.entrySet()) {
                        ...
                        lines.add(new StringTextComponent("").append(itemName).append(" = +").append(LocaleUtil.localizeRfFlowComponent(rf)));
                    }
