...
public class RenderDynamoMJ extends TileEntityRenderer<TileDynamoMJ> {
    // public static final RenderDynamoMJ INSTANCE = new RenderDynamoMJ();

    public RenderDynamoMJ(TileEntityRendererDispatcher context) {
        super(context);
    }

    @Override
    public void render(
            TileDynamoMJ engine, float partialTicks, MatrixStack poseStack, IRenderTypeBuffer bufferSource, int lightc, int combinedOverlay
    ) {
        ...
        IVertexBuilder vb = bufferSource.getBuffer(RenderType.cutout());
