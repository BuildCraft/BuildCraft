...
//    public static final RegistryObject<Biome> OIL_OCEAN = BIOMES.register(BCWorldGenNames.BIOME_OIL_OCEAN, () -> BCBiomes.makeOilOceanBiome());
    ...
    public static final RegistryKey<Biome> RESOURCE_KEY_BIOME_OIL_DESERT = RegistryKey.create(Registry.BIOME_REGISTRY, new ResourceLocation(BCEnergy.MODID, BIOME_OIL_DESERT));
    public static final RegistryKey<Biome> RESOURCE_KEY_BIOME_OIL_OCEAN = RegistryKey.create(Registry.BIOME_REGISTRY, new ResourceLocation(BCEnergy.MODID, BIOME_OIL_OCEAN));
