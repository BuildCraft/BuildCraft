...
public class BuildCraftTransport {
	...
	public void preInitialize(FMLPreInitializationEvent evt) {
		try {
			...
			// Fix the recipe
			// pipeItemsStipes = createPipe(DefaultProps.PIPE_ITEMS_STRIPES_ID, PipeItemsStripes.class, "Stripes Transport Pipe", new ItemStack(Item.dyeBlack), Block.glass, new ItemStack(Item.dyeYellow));

			pipeItemsVoid = createPipe(DefaultProps.PIPE_ITEMS_VOID_ID, PipeItemsVoid.class, "Void Transport Pipe", new ItemStack(Item.dyeBlack),
			...
			AssemblyRecipe.assemblyRecipes.add(new AssemblyRecipe(new ItemStack[] { new ItemStack(Item.dyeRed), new ItemStack(Item.redstone, 1),
			...
			AssemblyRecipe.assemblyRecipes.add(new AssemblyRecipe(new ItemStack[] { new ItemStack(Item.dyeBlue), new ItemStack(Item.redstone, 1),
			...
			AssemblyRecipe.assemblyRecipes.add(new AssemblyRecipe(new ItemStack[] { new ItemStack(Item.dyeGreen), new ItemStack(Item.redstone, 1),
			...
			AssemblyRecipe.assemblyRecipes.add(new AssemblyRecipe(new ItemStack[] { new ItemStack(Item.dyeYellow), new ItemStack(Item.redstone, 1),
