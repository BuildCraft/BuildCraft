...
public class PipeItemRenderer {// implements IItemRenderer {
    ...
    //
    // private void renderPipeItem(RenderBlocks render, ItemStack item, float translateX, float translateY, float
    // translateZ) {
    ...
    // block.setBlockBounds(CoreConstants.PIPE_MIN_POS + zFightOffset, 0.0F + zFightOffset, CoreConstants.PIPE_MIN_POS +
    // zFightOffset,
    ...
    // if (icon == null) {
    // icon = ((TextureMap)
    // Minecraft.getMinecraft().getTextureManager().getTexture(TextureMap.locationBlocksTexture)).getAtlasSprite(
    // "missingno");
    // }
    //
    // block.setBlockBounds(CoreConstants.PIPE_MIN_POS, 0.0F, CoreConstants.PIPE_MIN_POS, CoreConstants.PIPE_MAX_POS,
    // 1.0F,
