...
public class PipeFlowRedstoneFlux extends PipeFlow implements IFlowRedstoneFlux, IDebuggable {
    ...
    public Vector3d clientDisplayFlowCentre = VecUtil.VEC_HALF;
    public Vector3d clientDisplayFlowCentreLast = VecUtil.VEC_HALF;
    ...
    public PipeFlowRedstoneFlux(IPipe pipe, CompoundNBT nbt) {
        super(pipe, nbt);
    ...
    public void getDebugInfo(List<ITextComponent> left, List<ITextComponent> right, Direction side) {
        left.add(new StringTextComponent("maxPower = " + maxPower));
