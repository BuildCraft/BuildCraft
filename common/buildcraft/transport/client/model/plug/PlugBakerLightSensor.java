...
public enum PlugBakerLightSensor implements IPluggableModelBaker<KeyPlugLightSensor> {
    INSTANCE;
    ...
    @Override
    public List<BakedQuad> bake(KeyPlugLightSensor key) {
        MutableQuad[] quads = BCTransportModels.LIGHT_SENSOR.getCutoutQuads();
        if (quads != lastSeen) {
            cached.clear();
