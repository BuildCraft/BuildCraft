...
public class ContainerDiamondPipe extends ContainerPipe {
    ...
    public ContainerDiamondPipe(ContainerType menuType, int id, PlayerEntity player, PipeBehaviourDiamond pipe) {
...
//                addSlotToContainer(new Slot(player.inventory, k1 + l * 9 + 9, 8 + k1 * 18, 140 + l * 18));
                addSlot(new Slot(player.inventory, k1 + l * 9 + 9, 8 + k1 * 18, 140 + l * 18));
            }
        }

        for (int i1 = 0; i1 < 9; i1++) {
//            addSlotToContainer(new Slot(player.inventory, i1, 8 + i1 * 18, 198));
            addSlot(new Slot(player.inventory, i1, 8 + i1 * 18, 198));
        }
    }
