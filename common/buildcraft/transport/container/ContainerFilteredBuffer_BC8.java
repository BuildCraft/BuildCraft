...
public class ContainerFilteredBuffer_BC8 extends ContainerBCTile<TileFilteredBuffer> {
    public ContainerFilteredBuffer_BC8(ContainerType menuType, int id, PlayerEntity player, TileFilteredBuffer tile) {
...
//                    return BCTransportSprites.EMPTY_FILTERED_BUFFER_SLOT.getSprite();
                    return Pair.of(AtlasTexture.LOCATION_BLOCKS, BCTransportSprites.EMPTY_FILTERED_BUFFER_SLOT.getSprite().getName());
                }
