...
public class GuiFluidsDiamondPipe extends GuiBuildCraft {
	...
	public GuiFluidsDiamondPipe(IInventory playerInventory, PipeFluidsDiamond pipe) {
		super(new ContainerFluidsDiamondPipe(playerInventory, pipe), pipe.getFilters());
