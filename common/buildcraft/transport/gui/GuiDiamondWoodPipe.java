...
public class GuiDiamondWoodPipe extends GuiBC8<ContainerDiamondWoodPipe> implements IButtonClickEventListener {
    ...
    protected void drawForegroundLayer() {
        ...
        double titleX = mainGui.rootElement.getX() + (xSize - fontRendererObj.getStringWidth(title)) / 2;
        fontRendererObj.drawString(title, (int) titleX, (int) mainGui.rootElement.getY() + 6, 0x404040);
        fontRendererObj.drawString(LocaleUtil.localize("gui.inventory"), (int) mainGui.rootElement.getX() + 8, (int) mainGui.rootElement.getY() + ySize - 93, 0x404040);
