...
public class DockingStationPipe extends DockingStation implements IRequestProvider {
    ...
    public ISidedInventory getItemInput() {
        ...
        TileEntity connectedTile = getPipe().getWorldBC().getTileEntity(getPos().add(Utils.convertFloor(dir)));
    ...
    public IRequestProvider getRequestProvider() {
        for (EnumFacing dir : EnumFacing.VALUES) {
            TileEntity nearbyTile = getPipe().getWorldBC().getTileEntity(getPos().add(Utils.convertFloor(dir)));
