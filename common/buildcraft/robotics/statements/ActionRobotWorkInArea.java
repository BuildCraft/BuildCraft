...
public class ActionRobotWorkInArea extends BCStatement implements IActionInternal {
    ...
    public ITextComponent getDescription() {
        return new TranslationTextComponent(areaType.getUnlocalizedName());
    }

    @Override
    public String getDescriptionKey() {
        return areaType.getUnlocalizedName();
    }

    @Nullable
    @Override
    public ISprite getSprite() {
        return BCRoboticsSprites.ACTION_ROBOT_AREA_TYPE.get(areaType);
    }
