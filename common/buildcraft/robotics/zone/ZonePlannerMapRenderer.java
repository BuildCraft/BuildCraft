...
//            GL11.glDeleteLists(glList, 1);
    ...
    private void vertex(IVertexBuilder builder, double x, double y, double z) {
...
//        vertex.renderPositionColour(poseStack.last(), builder);
    ...
    public void drawBlockCuboid(IVertexBuilder builder, double x, double y, double z, double height, double radius) {
    ...
    public void drawBlockCuboid(IVertexBuilder builder, double x, double y, double z, double height) {
//        drawBlockCuboid(builder, x, y, z, height, 0.5);
        drawBlockCuboid(builder, x, y, z, height, 0.5);
    }

    // public void drawBlockCuboid(BufferBuilder builder, double x, double y, double z)
    public void drawBlockCuboid(IVertexBuilder builder, double x, double y, double z) {
