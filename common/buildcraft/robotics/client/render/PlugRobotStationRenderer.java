...
//    private final List<MutableQuad> modelBaseQuads = new ArrayList<>();
    ...
    @Override
    public void render(PluggableRobotStation robotStation, float partialTicks, MatrixStack poseStack, IVertexBuilder bb, int combinedLight, int combinedOverlay) {
