...
public class EntityRobotEnergyParticle extends SmokeParticle {
    ...
    public EntityRobotEnergyParticle(ClientWorld world, double x, double y, double z, double vx, double vy, double vz, IAnimatedSprite spriteSet) {
    ...
    public EntityRobotEnergyParticle(ClientWorld world, double x, double y, double z, double vx, double vy, double vz, float size, IAnimatedSprite spriteSet) {
