...
A wrench provides the solution: this can modify the state of a machine or many blocks with a simple whack.
</lore>
<no_lore>
The wrench is the basic tool which is used to rotate and manipulate blocks, machines and some entities with a simple click.
</no_lore>
