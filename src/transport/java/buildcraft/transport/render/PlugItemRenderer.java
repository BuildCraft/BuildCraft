...
public class PlugItemRenderer {// implements IItemRenderer {
    //
    // private void renderPlugItem(RenderBlocks render, ItemStack item, float translateX, float translateY, float
    // translateZ) {
    // // Render StructurePipe
    // Block block = BuildCraftTransport.genericPipeBlock;
    // Tessellator tessellator = Tessellator.instance;
    // TextureAtlasSprite textureID =
    // BuildCraftTransport.instance.pipeIconProvider.getIcon(PipeIconProvider.TYPE.PipeStructureCobblestone
    // .ordinal()); // Structure
    // // pipe
    //
