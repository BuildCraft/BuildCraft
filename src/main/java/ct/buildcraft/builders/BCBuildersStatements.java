...
import ct.buildcraft.builders.snapshot.pattern.PatternShape2dCircle;
import ct.buildcraft.builders.snapshot.pattern.PatternShape2dHexagon;
import ct.buildcraft.builders.snapshot.pattern.PatternShape2dOctagon;
import ct.buildcraft.builders.snapshot.pattern.PatternShape2dPentagon;
import ct.buildcraft.builders.snapshot.pattern.PatternShape2dSemiCircle;
import ct.buildcraft.builders.snapshot.pattern.PatternShape2dSquare;
import ct.buildcraft.builders.snapshot.pattern.PatternShape2dTriangle;
import ct.buildcraft.builders.snapshot.pattern.PatternSphere;
import ct.buildcraft.builders.snapshot.pattern.PatternSpherePart;
import ct.buildcraft.builders.snapshot.pattern.PatternStairs;
import ct.buildcraft.builders.snapshot.pattern.parameter.PatternParameterAxis;
