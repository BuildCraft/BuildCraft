...
public class mod_BuildCraftFactory extends BaseModMp {	
	...
	public void ModsLoaded () {		
		...
		Core.addName(miningWellBlock.setBlockName("miningWellBlock"), "Mining Well");
		...
		Core.addName(plainPipeBlock.setBlockName("plainPipeBlock"), "Mining Pipe");
		...
		Core.addName(autoWorkbenchBlock.setBlockName("autoWorkbenchBlock"),
		...
		Core.addName(machineBlock.setBlockName("machineBlock"),
		"Quarry");
