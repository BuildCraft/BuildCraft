...
public class BuildCraftEffectRenderer extends EffectRenderer
{
    ...
    public BuildCraftEffectRenderer(World world, RenderEngine renderengine)
    {	
	...
	public void addDigParticleEffect(EntityDiggingFX dig_effect, Block block)
	{
		...
		{
			comp = ((ICustomTextureBlock)block).getTextureFile();
		}
		else
		{
			comp = "/terrain.png";
